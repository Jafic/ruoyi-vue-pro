...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("CCOC");
        ...
        desensitizeDemo.setRegex("你好，我是CCOC");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("CCOC");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "CCOC", replacer = "*")
